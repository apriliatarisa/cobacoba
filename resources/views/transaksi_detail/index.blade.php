                        ...
                        <div class="box-body">
                            ...
                            <form class="form-produk">
                                ...
                                <div class="form-group row">
                                    {{-- <label for="barang_id" class="col-lg-2">Kode barang</label> --}}
                                    <div class="col-lg-5">
                                        <div class="input-group">
                                            ...
                                            <span class="input-group-btn">
                                                <button onclick="tampilBarang()" class="btn btn-success btn-flat" type="button"><i>Cari Barang</i></button>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <form action="{{ route('transaksi.simpan') }}" class="form-penjualan" method="post">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="number" id="diterima" class="form-control" name="diterima" value="1">
                                            </div>
                                        </div>
                                        <div class="form-group row">
            ...
            <script>
                ...
                $(function () {
                    ...
                    table = $('.table-transaksi').DataTable({
                        ...
                        autoWidth: false,
                        ajax: {
                            url: '{{ route('transaksi.index', $id_transaksi) }}',
                        },
                        columns: [
